...
unifiedparticleTransformerAK4SonicTriton.toReplaceWith(pfUnifiedParticleTransformerAK4JetTags, _pfUnifiedParticleTransformerAK4SonicJetTags.clone(
    Client = cms.PSet(
        ...
        modelName = cms.string("unifiedparticletransformer_AK4_V01"), # double check
        modelConfigPath = cms.FileInPath("RecoBTag/Combined/data/models/unifiedparticletransformer_AK4_V01/config.pbtxt"), # this is SONIC, not currently in the CMSSW, so the models/ will be copied to this location privately
